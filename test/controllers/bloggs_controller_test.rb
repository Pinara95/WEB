...
class BloggsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogg" do
    assert_difference('Blogg.count') do
      post bloggs_url, params: { blogg: { adresse: @blogg.adresse, email: @blogg.email, plz: @blogg.plz } }
    end
  ...
  test "should update blogg" do
    patch blogg_url(@blogg), params: { blogg: { adresse: @blogg.adresse, email: @blogg.email, plz: @blogg.plz } }
